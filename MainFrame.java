...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		btnQuickSort.setBounds(250, 267, 150, 34);
		...
		btnHeapSort.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				boolean check = handleInput(txtFieldArraySize.getText().trim(), txtFieldArrayValues.getText().trim());
				if (check == true) {
					new SortFrame(array, "Heap Sort");
				}
				
			}
		});
		btnHeapSort.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btnHeapSort.setBounds(427, 267, 150, 34);
		...
		btnRadixSort.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				boolean check = handleInput(txtFieldArraySize.getText().trim(), txtFieldArrayValues.getText().trim());
				if (check == true) {
					new SortFrame(array, "Radix Sort");
				}
				
			}
		});
		btnRadixSort.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btnRadixSort.setBounds(604, 267, 150, 34);
		...
		btnExit.setBounds(605, 339, 150, 34);
